...
type NetworkInterface struct {
	...
	Flags     NetworkInterfaceFlags `bun:"flags,type:json" json:"flags" jsonschema:"description=Network interface flags"`
...
type networkInterfaceUnmarshallingAlias struct {
	...
	Flags   NetworkInterfaceFlags `json:"flags" jsonschema:"description=Network interface flags"`
}
