...
HostNetworkModule retrieves basic network information about the host: interfaces along with their name, MAC address, IP addresses (IPv4 and IPv6), subnet masks, and default gateway.

### Details


It uses the [net](https://pkg.go.dev/net) standard library and [go-netroute](https://github.com/libp2p/go-netroute) for gateway detection.
